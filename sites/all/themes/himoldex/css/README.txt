...
To use these stylesheets, rename the files and himoldex with the name of your theme.
...
himoldex-alpha-default-narrow.css  
...
himoldex-alpha-default-normal.css
...
himoldex-alpha-default-wide.css
